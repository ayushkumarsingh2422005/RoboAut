...
const ResourcesSection = () => {
  ...
  return (
    <section id="resources" className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-gradient-to-br from-gray-900 via-black to-blue-900">
      {/* Background Effects */}
            ...
            <div className="flex space-x-2">
              {categories.map((category) => (
                <button
                  ...
                  className={`flex items-center space-x-3 px-6 py-3 font-exo2 font-medium rounded-xl transition-all duration-300 ${
                ...
                >
                  ...
                  <span className={`px-2 py-1 rounded-full text-xs ${
                    activeCategory === category.id ? 'bg-white/20' : 'bg-blue-500/20'
                  }`}>
                    {category.count}
                  </span>
                </button>
