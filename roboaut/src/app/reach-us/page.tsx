  ...
  const teamContacts = [
    {
      name: 'Rajesh Patel',
      position: 'President',
      email: 'president@roboaut.nitjsr.ac.in',
      phone: '+91 9876543210',
    ...
    },
    {
      ...
      email: 'tech@roboaut.nitjsr.ac.in',
      phone: '+91 7654321098',
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className="w-full px-4 py-3 bg-black/50 border border-blue-500/30 rounded-lg text-white font-exo2 focus:border-blue-400 focus:outline-none transition-colors duration-300"
                        required
                      >
                    ...
                    <button
                      type="submit"
                      className="w-full relative px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-exo2 font-semibold text-lg transition-all duration-300 hover:from-blue-500 hover:to-purple-500 hover:scale-105 hover:shadow-[0_0_30px_rgba(59,130,246,0.5)]"
                      style={{
