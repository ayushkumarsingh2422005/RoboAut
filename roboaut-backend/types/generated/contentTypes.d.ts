...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Type: Schema.Attribute.Enumeration<
      ['Workshop', 'Seminars', 'Competitons', 'Other']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiFormForm extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Contact: Schema.Attribute.BigInteger & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Email: Schema.Attribute.Email & Schema.Attribute.Required;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::form.form'> &
      Schema.Attribute.Private;
    ParticipantName: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPorPor extends Struct.CollectionTypeSchema {
  collectionName: 'pors';
  info: {
    displayName: 'POR';
    pluralName: 'pors';
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::por.por'> &
      Schema.Attribute.Private;
...
export interface ApiResourceResource extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Title: Schema.Attribute.String & Schema.Attribute.Required;
    Type: Schema.Attribute.Enumeration<
      ['Learning Resource', 'workshop Material ']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
